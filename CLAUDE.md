...
- [Three run modes](docs/references/three-mode-architecture.md) — embedded `engram mcp`, daemon `engram serve`, thin `engram client`; the EngramBackend seam and the dream scheduler's lease.
